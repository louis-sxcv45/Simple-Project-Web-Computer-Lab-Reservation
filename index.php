        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="./user/data_pinjam_ruang.php">
                    ...
                    <li class="nav-link">
                        <a href="./user/data_pinjam_barang.php">
    ...
    <section class="home">
        ...
        <div class="dashboard-content">
            ...
            <div class="card">
                ...
                <div class="text-content">
                    <h2><?php echo $totalPeminjamanUserRu; ?></h2>
            ...
            <div class="card">
                ...
                <div class="text-content">
                    <h2><?php echo $totalPeminjamanUser; ?></h2>
